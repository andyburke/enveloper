...
module.exports = {
    ...
    handler: async options => {
        ...
        const envelope_contents = fs.existsSync( envelope_path ) ? fs.readFileSync( envelope_path ) : '{}';
        ...
        fs.writeFileSync( envelope_path, JSON.stringify( envelope, null, indent_info && indent_info.amount || 4 ) );
